...
export const swipeRight = async (req, res) => {
  try {
    ...
    if (!currentUser.likes.includes(likedUserId)) {
      ...
      // ✅ FIX 3a: Use .toString() consistently for ObjectId comparisons
      if (likedUser.likes.some((id) => id.toString() === currentUser._id.toString())) {
...
export const getMatches = async (req, res) => {
  try {
    // ✅ FIX 3b: populate _id too (needed by Sidebar for chat links)
